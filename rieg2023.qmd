...
Cooperative Patent Classification is a classification system by the European Patent Office and the US Patent and Trademark Office that allows for a structural hierarchical classification of patents [@cooperat]. As seen in @tbl-cpc-codes, CPC codes are composed of a section (alphabetical), class (numerical), subclass (alphabetical), and main group (numerical). The CPC codes are used to retrieve patents that utilize artificial intelligence technology.
...
#TODO: Note that monetary value has not been inflation adjusted
...
TODO: monetary values not adjusted, more economic indicators could have been chosen.
