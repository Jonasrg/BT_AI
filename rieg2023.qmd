...
Additionally Coopoerative Patent Classification (CPC) codes are used to retrieve patents that utilize artificial intelligence technology. As there is no clear mapping between the Europoean Commission's definition and CPC codes, classifications are chosen to the author's best knowledge.

```{python}
# show cpc codes as table
import yaml
import pandas as pd
import source.visuals as vis
